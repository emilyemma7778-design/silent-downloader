...
if "target_url" in st.session_state and url_input.strip():
    ...
    with st.spinner("ভিডিও ডাউনলোড এবং প্রসেস করা হচ্ছে..."):
        try:
            ...
            # 🔥 সেফ এবং নমনীয় ফরম্যাট সিলেকশন (যাতে ফরম্যাট মিসিং এরর না আসে)
            if "1080p" in chosen_q:
                fmt = 'bestvideo[height<=1080]+bestaudio/bestvideo[height<=1080]/best[height<=1080]/best'
            elif "720p" in chosen_q:
                fmt = 'bestvideo[height<=720]+bestaudio/bestvideo[height<=720]/best[height<=720]/best'
            elif "480p" in chosen_q:
                fmt = 'bestvideo[height<=480]+bestaudio/bestvideo[height<=480]/best[height<=480]/best'
            elif "360p" in chosen_q:
                fmt = 'bestvideo[height<=360]+bestaudio/bestvideo[height<=360]/best[height<=360]/best'
            ...
            st.error(f"প্রসেস করতে সমস্যা হয়েছে: {str(e)}")
